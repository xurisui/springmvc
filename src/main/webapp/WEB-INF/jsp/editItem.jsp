...
<body> 
	...
	<!-- <form id="itemsForm" action="" method="post" enctype="multipart/form-data"> -->
	<form id="itemsForm"	action="${pageContext.request.contextPath }/updateitems.action" method="post">
